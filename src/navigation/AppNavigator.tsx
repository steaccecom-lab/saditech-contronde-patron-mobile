  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{title: 'Accueil', tabBarIcon: DotIcon}}
      />
      <Tab.Screen
        name="Rounds"
        component={RoundsScreen}
        options={{title: 'Rondes', tabBarIcon: DiamondIcon}}
      />
      <Tab.Screen
        name="Agents"
        component={AgentsScreen}
        options={{title: 'Agents', tabBarIcon: SquareIcon}}
      />
      <Tab.Screen
        name="Settings"
        component={SettingsScreen}
        options={{title: 'Paramètres', tabBarIcon: DotIcon}}
      />
    </Tab.Navigator>
  );
}
    ...
    const subscription = AppState.addEventListener('change', state => {
      if (state === 'active') {
        ...
        queryClient
          ...
          .catch(() => undefined);
        queryClient
          .invalidateQueries({queryKey: ['notificationUnreadCount']})
          .catch(() => undefined);
      }
    });
        ...
        {user ? (
          <>
            ...
            <Stack.Screen
              ...
              options={{title: 'Détail ronde'}}
            />
            <Stack.Screen
              name="AgentRounds"
              component={AgentRoundsScreen}
              options={{title: 'Historique agent'}}
            />
          </>
        ) : (
          <Stack.Screen
