  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.card}>
        <Text style={styles.line}>Statut: {round.finalStatus === 'INCOMPLETE' ? 'Incomplète' : round.finalStatus === 'MISSED' ? 'Manquée' : round.finalStatus === 'COMPLETED' ? 'Terminée' : statusLabel(round.status)}</Text>
        {round.autoClosedAt ? <Text style={styles.line}>Durée maximale atteinte — clôture automatique : {formatDateTime(round.autoClosedAt)}</Text> : null}
